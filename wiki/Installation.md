...
If you run a feature-gated subcommand on a build that lacks the feature, CodeGraph prints a
...
The first `extract` writes a `codegraph-out/` directory next to your code. See
