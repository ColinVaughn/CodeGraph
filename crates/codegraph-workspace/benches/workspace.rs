//! Criterion benchmarks for `codegraph-workspace` federation kernels.
//!
...
//!     scenario.
//!
//! Run: `cargo bench -p codegraph-workspace`

use std::path::PathBuf;

use codegraph_core::{Confidence, Edge, FileType, GraphData, Node, NodeId};
use codegraph_workspace::alias::collect_aliases;
use codegraph_workspace::coordinate::{Coordinate, Ecosystem};
use codegraph_workspace::export_surface::{
    build_export_surface, resolve_cross_repo, ExportSurface,
};
use codegraph_workspace::federate::{compose, prefix_graph};
use criterion::{
            ...
            b.iter_batched(
                ...
                |g| {
                    black_box(resolve_cross_repo(
                        g,
                        &surfaces,
                        &codegraph_workspace::alias::AliasMap::default(),
                    ))
                },
                BatchSize::SmallInput,
            );
