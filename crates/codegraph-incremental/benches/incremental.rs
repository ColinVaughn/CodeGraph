//! Criterion benchmarks for `codegraph-incremental` core merge primitives on
...
//! inner stages.
//!
//! Run: `cargo bench -p codegraph-incremental`

use std::collections::HashSet;

use codegraph_core::{Confidence, Edge, FileType, GraphData, Node, NodeId};
use codegraph_incremental::{merge_incremental, topology, union_graphs};
use criterion::{
