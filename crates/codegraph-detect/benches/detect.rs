//! Criterion benchmarks for `codegraph-detect` — the file-discovery walk that
...
//!
//! Run: `cargo bench -p codegraph-detect`

use std::path::{Path, PathBuf};

use codegraph_detect::{detect, noise::is_noise_dir};
use criterion::{black_box, criterion_group, criterion_main, Criterion};
use ignore::WalkBuilder;

/// The workspace `crates/` dir (this crate is `crates/codegraph-detect`).
